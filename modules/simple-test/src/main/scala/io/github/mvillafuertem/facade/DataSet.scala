...
class DataSet(data: js.UndefOr[js.Array[js.Dictionary[Any]]] = js.undefined, options: js.UndefOr[js.Dictionary[Any]] = js.undefined) extends js.Object {
...
object DataSet {
  ...
  def apply(data: js.UndefOr[js.Array[js.Dictionary[Any]]] = js.undefined, options: js.UndefOr[js.Dictionary[Any]] = js.undefined): DataSet =
