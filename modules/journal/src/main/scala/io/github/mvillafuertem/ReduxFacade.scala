...
import typings.redux.mod.{Action, Dispatch, Reducer, Store}
...
object ReduxFacade {
  ...
  /* take a store and a component which takes `dispatch` and `state` as props, return a component with those filled */
  def multiConnect[State <: js.Any, Action <: js.Any, P <: js.Object](
                                                                        store: Store[State, Action],
                                                                        c: ScalaFn.Component[Dictionary[Connected[State, Action] ] with P, CtorType.Props]
                                                                      ): Js.Component[P, Null, CtorType.PropsAndChildren] = {
