...
import io.github.mvillafuertem.auth.{AuthContext, AuthProvider, ChatState}
import japgolly.scalajs.react.component.ScalaFn.Component
import japgolly.scalajs.react.vdom.html_<^.{<, _}
import japgolly.scalajs.react.{Callback, CtorType, ReactEventFromInput, ScalaFnComponent}
import typings.react.mod.{Context, EffectCallback, useContext, useEffect, useState}
...
object LoginPage {
  ...
  val component: Component[Unit, CtorType.Nullary] = ScalaFnComponent[Unit] { _ =>
    ...
    //val value = useContext(AuthContext().asInstanceOf[Context[ChatState]])
